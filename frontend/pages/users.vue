          ...
          <div class="field">
            ...
            <div class="control">
              <input
                class="input"
                type="text"
                placeholder="What is your user's name?"
                v-model="user.name"
              />
            </div>
          </div>
          <div class="field">
            ...
            <div class="control">
              <textarea
                ...
                placeholder="Describe your user succintly"
              ></textarea>
            </div>
          </div>
          <div class="file">
            <label class="file-label">
              ...
              <span class="file-cta">
                ...
                <span class="file-label">Upload a user image…</span>
              </span>
            </label>
          </div>
          <br />
...
export default {
  ...
  methods: {
    ...
    async uploadUser() {
      ...
      try {
        let response = await fetch("http://localhost:9000/api/user/new", {
          method: "post",
          body: formData
        });
        this.$router.push("/");
